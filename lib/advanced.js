...
/*
  ...
  The validation draws NEVER
  participate in generating candidates.

  Candidate construction uses:

  strongest repeated triples
  +
  strongest repeated pairs.

  Ranking prioritizes:

  1. 4/5 and 5/5 performance
  2. performance in BOTH validation blocks
  3. 3/5 consistency
  ...
  cannot simply be selected again unchanged.
*/
  ...
  for (
    ...
    for (
      ...
      */
      ...
      /*
        Triple gets stronger weight
        because the entire Advanced
        concept is looking for
        repeated multi-number structure.
      */
    ...
    [...pool.values()]
      .map(
        c => {
          ...
          /*
            Strong group should work
            in BOTH validation periods.

            Therefore we also use the
            weaker block as a major score.
          */
  ...
  ranked.sort(
    (a, b) =>
      ...
      */
      ...
      /*
        Fifth:
        historical triple/pair strength.
      */
...
async function initialBackfill(
  ...
  */
  ...
  /*
    Batch insert instead of
    one request per draw.
  */
...
async function runAdvanced() {
  ...
  /*
    Do not change the Advanced Group
    after it has already been selected.
  */
  ...
  */
  ...
  /*
    Keep Special Group too.
    Advanced Group is an additional
    independent method.
  */
  ...
  /*
    Freeze the selected numbers
    at the end of the 180-draw
    collection.
  */
  ...
  /*
    If this feature is first installed
    after 6:05 PM, replay only draws
    AFTER the collection end.

    Those draws were NOT used by
