...
/*
  ...
  We prefer groups that repeatedly
  produce 3/5 or better in BOTH
  validation periods.

  4/5 and 5/5 receive higher priority.

  Long periods without 3/5 are penalized.
*/
...
function buildActiveDensitySpecial(
  ...
  /*
    Validation A reduces thousands
    of candidates to the best 50.
  */
  ...
  */
  ...
  return {
    ...
    validationTotalThreePlus:
      validation60.threePlus,

    validationTotalFourPlus:
      validation60.fourPlus,

    validationMeanGap:
      validation60.meanGap,
...
async function runActiveDensitySpecial() {
  ...
  /*
    If this cycle already received
    Active-Density Special,
    never change its numbers again.
  */
